                            ...
                            <tr key={contact.id}>
                                ...
                                <td>
                                    <ul className="list-unstyled">
                                        <li className="d-inline pr-3"><Link to={`/update-contact/${contact.id}`} className="text-dark"><BsPencil/></Link></li>
                                        <li className="d-inline remove-icon" onClick={() => handleDelete(contact.id)}><BsTrash/></li>
                                    </ul>
                                </td>
                            </tr>
                            ))} 
